...
1. Migration 0020: `space_facts` table
2. Migration 0022: `space_facts_mining_jobs` (queue)
3. Backend endpoints:
...
### Migration 0022: space_facts_mining_jobs
...
### Happy Path
- [ ] AC-1: Migration 0020 + 0022 跑得起來、down.sql 可 rollback
